          ...
          <form action="post">
            <div class="input">
              ...
              <input
                ...
                class="form-control"
                :class="{ 'is-invalid': !login.email }"
                v-model.trim="loginText.email"
              />
            ...
            <div class="input">
              ...
              <input
                ...
                placeholder="請輸入密碼"
                class="form-control"
                :class="{ 'is-invalid': !login.password }"
                v-model.trim="loginText.password"
              />
          ...
          <form>
            <div class="input">
              ...
              <input
                ...
                placeholder="請輸入姓名"
                class="form-control"
                :class="{ 'is-invalid': !register.name }"
                v-model.trim="registerText.registerName"
              />
            ...
            <div class="input">
              ...
              <input
                ...
                placeholder="請輸入email"
                class="form-control"
                :class="{ 'is-invalid': !register.email }"
                v-model.trim="registerText.registerEmail"
              />
              <div class="invalid-feedback">email格式錯誤</div>
            </div>
            <div class="input">
          ...
          <form action="">
            <div class="input">
              ...
              <input
                ...
                placeholder="請輸入email"
                class="form-control"
                :class="{ 'is-invalid': !changeEmail }"
                v-model.trim="changeEmailText.email"
              />
              <div class="invalid-feedback">email格式錯誤</div>
            </div>
...
const send = function () {
  ...
  axios
    .post(`${import.meta.env.VITE_API_URL}emailapi.php`, params)
    .then((res) => {
...
const sendEmailPHP = () => {
  ...
  axios
    .post(`${import.meta.env.VITE_API_URL}sendEmail.php`, params) //使用get或post等取得路徑資料(php)
...
const registerButton = () => {
  ...
  if (
    registerText.registerEmail === "" ||
    !emailRule.test(registerText.registerEmail)
  ) {
...
const registerPHP = function () {
  ...
  axios
    .post(`${import.meta.env.VITE_API_URL}register.php`, params) //使用get或post等取得路徑資料(php)
...
const loginPHP = function () {
  ...
  axios
    .post(`${import.meta.env.VITE_API_URL}login.php`, params) //使用get或post等取得路徑資料(php)
