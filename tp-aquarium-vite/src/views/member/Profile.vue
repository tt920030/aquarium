<template>
  <div class="profile wrapper">
    <Photo
      v-if="show"
      @closePhoto="showPhoto()"
      :id="profileText.photo_id"
      @reload="getProfile"
    ></Photo>
    <div class="top">
      ...
      <div class="inner-right">
        <div class="input">
          ...
          <input
            ...
            name="email"
            disabled="disabled"
            v-model.trim="profileText.email"
          />
        </div>
      </div>
    </div>
      ...
      <form action="post" method="" class="" @submit.prevent="onSubmit">
        <div class="input">
          ...
          <input
            ...
            :class="{ '-on': !isButtonDisabled }"
            v-model.trim="profileText.name"
          />
        ...
        <div class="input">
          ...
          <input
            ...
            :disabled="isButtonDisabled"
            :class="{ '-on': !isButtonDisabled }"
            v-model.trim="profileText.phone"
          />
        </div>
        <div class="input">
          ...
          <input
            ...
            name="password"
            disabled
            v-model.trim="profileText.password"
          />
          <button
            class="change"
            v-if="!isButtonDisabled"
        ...
        <div class="input">
          ...
          <input
            ...
            :disabled="isButtonDisabled"
            :class="{ '-on': !isButtonDisabled }"
            v-model.trim="profileText.address"
          />
        </div>
...
const changePofile = () => {
  ...
  axios
    .post(`${import.meta.env.VITE_API_URL}changeProfile.php`, params)
    .then((res) => {
