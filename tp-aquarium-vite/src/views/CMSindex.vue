<template>
  ...
  <main class="cms">
    <div v-if="clicked>0" class="mb-3">
      <h3 id="title">{{ clicked?manages[clicked].name:'' }}</h3>
      <button>
        <RouterLink :to="clicked?manages[clicked].change:''">{{clicked?manages[clicked].active1:''}}</RouterLink>
...
const manages=[
{name:'請選擇管理項目'},
{name:'消息管理',change:'news_change',active1:'新增消息'},
{name:'商品管理',change:'product_change',active1:'新增商品'},
{name:'行程管理',change:'journey_create',active1:'新增行程'},
