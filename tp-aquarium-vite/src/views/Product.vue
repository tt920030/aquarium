    ...
    <div class="product">
        ...
        <main>
            <div class="wrapper navigation">
                <p>網路商城 > </p>
<<<<<<< HEAD
                <a href=""><p class="product_name"> {{ data.name }}</p></a>
            </div>
            <div class="wrapper content">
                <div class="photo">
                    ...
                    <div>
                        ...
                        alt="" 
                        @click="imgUrl = img; currentImg = index">
=======
                <a href=""><p class="product_name"> 企鵝娃娃</p></a>
            </div>
            <div class="wrapper content">
                <div class="photo">
...
=======
                        <h3 class="product_name">企鵝娃娃</h3>
                        <h4 class="product_price">NTD $500</h4>
                        <p class="product_intro">企鵝絨毛娃娃的外觀可愛，經典的設計包括黑白相間的身體和圓滾滾的身材，令人難以抗拒。面料使用高品質的絨毛製成，手感柔軟舒適。</p>    
>>>>>>> anniesu
                    </div>
                    <div class="numberBtn">
                        <!-- 增加按鈕 -->
...
<<<<<<< HEAD
                ...
                <div class="precautionTitle">
                    ...
                    v-for="tab in tabs" 
                    :key="tab.id"
                    @click="currentTab = tab.id ;clickHandle() " 
                    :class="{btnOn: currentTab == tab.id}">{{ tab.title }}</button>
                    <span></span>
                </div>
                <div>
                    <p>{{ contentShow }}</p>
=======
                <div>
                    <h4 v-for="tab in tabs">{{ tab.id }}</h4>
                    <h4 class="freeDelivery">免運標準</h4>
                    <h4 class="payment ">付款方式</h4>
                    <h4 class="">出貨時間</h4>
                    <h4 class="refund  btnOn">退換貨須知</h4>
                    <span></span>
                </div>
                <div>
                    <p class="">滿NTD 1000即可享有免運</p>
                    <p class="">信用卡<br>第三方支付</p>
                    <p class="">將於付款完成後，5-7個工作天寄出</p>
                    <p class="contentShow">商品到貨享十天猶豫期之權益（注意！猶豫期非試用期），辦理退貨商品必須是全新狀態且包裝完整，商品一經拆封，等同商品價值已受損，僅能以福利品出售，若需退換貨，我方須收取價值損失之費用(回復原狀、整新費)，請先確認商品正確、外觀可接受，再行使用，以免影響您的權利。</p>
>>>>>>> anniesu
                </div>
            </div>
...
=======
    ...
    const tabs = reactive([
        ...
        },
        {
            id:'退換貨須知',
>>>>>>> anniesu
            content: '商品到貨享十天猶豫期之權益（注意！猶豫期非試用期），辦理退貨商品必須是全新狀態且包裝完整，商品一經拆封，等同商品價值已受損，僅能以福利品出售，若需退換貨，我方須收取價值損失之費用(回復原狀、整新費)，請先確認商品正確、外觀可接受，再行使用，以免影響您的權利。'   
        }
    ])
