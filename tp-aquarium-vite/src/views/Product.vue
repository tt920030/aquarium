...
<script setup>
    ...
    // 大圖src
    let imgUrl = 'public/img/product_1_1.jpg'
    // 預設大圖
    ...
    const product = reactive({
        ...
        imgs: [
        'public/img/product_1_1.jpg',
        'public/img/product_1_2.jpg',
        'public/img/product_1_3.jpg'
        ]
    })
    ...
    function addToCart(event){
        ...
        const data = {  "name": product.name , "price": product.price, "amount": counter.value, "img":  product.imgs[0]};
