<template>
    ...
    <div class="news">
        ...
        <main class="wrapper list">
            <ul>
                <RouterLink v-for="item in items.slice(9*(page.currentPage - 1) ,9*page.currentPage)" :to="{ path: '/news/news_page' }" :key="item.id">
                    <li>
                        <div class="container">
                            <!-- <img class="picture" :src="`@/img/${item.src}`" alt=""> -->
                            <img class="picture" :src="item.src" alt="">
        ...
        <Page :total-items="page.totalItems" :items-per-page="page.itemsPerPage" :current-page="page.currentPage"></Page>
