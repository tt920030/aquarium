      ...
      <ul class="floor_nav">
        <li>
          <RouterLink to="/floor_introduction"
            ><img src="https://tibamef2e.com/thd101/g6/img/floor_p1.svg" alt=""
          /></RouterLink>
          <h4>樓層介紹</h4>
        </li>
        <li>
        ...
        <li>
          <RouterLink to="/visit_information"
            ><img
              src="https://tibamef2e.com/thd101/g6/img/floor_p4_active.svg"
              alt=""
            />
          </RouterLink>
        ...
        <div class="contain">
          ...
          <div class="visit_mid">
            ...
            <div class="info">
              ...
              <div class="info_detail">
                ...
                <div class="mid_icon">
                  <img
                    class="person"
                    src="https://tibamef2e.com/thd101/g6/img/visitinfo1.svg"
                    alt=""
                  />
                  <p>出站直行150公尺後向右轉</p>
                </div>
            ...
            <div class="info">
              ...
              <div class="info_detail">
                ...
                <div class="mid_icon">
                  <img
                    class="bus"
                    src="https://tibamef2e.com/thd101/g6/img/visitinfo2.png"
                    alt=""
                  />
                  <p>下車後向右轉直行100公尺</p>
                </div>
            ...
            <div class="info">
              ...
              <div class="info_detail">
                ...
                <div class="mid_icon">
                  <img
                    class="car"
                    src="https://tibamef2e.com/thd101/g6/img/visitinfo3.png"
                    alt=""
                  />
                  <p>往海生館路直行600公尺</p>
                </div>
            ...
            <div class="park">
              <h3>停車場資訊</h3>
              <p class="opentime">
                開放時間：<br />平日(二~五)：8:30~17:30<br />周末(六~日)：8:00~18:30<br />周一休館日不開放
              </p>
              <table>
                <tbody>
                  <tr>
...
.visit_information {
  main {
    // background-image: url(..https://tibamef2e.com/thd101/g6/img/visit_information_bg.png);
    ...
    .banner {
      background-image: url(https://tibamef2e.com/thd101/g6/img/guided_tour_banner.jpg);
      width: 100%;
      height: 660px;
      background-size: cover;
