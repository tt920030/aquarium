            ...
            <div class="yearpass-mid">
                <div>
                    ...
                    <p>
                        ...
                        充滿歡樂的通行證。<br>
                        不管是何時都能享有平時購票更多的優惠!</p>
                </div>
                <img src="/src/img/yearpass_phone.svg" alt="">
            </div>
            <div class="yearpass-bottom">
                <h2>選擇購買張數</h2>
                <TicketCounter itinerary="年度通行證" @count="count" @total="total" @types="types" />
...
const expire = ref(new Date(today.value.setFullYear(today.value.getFullYear() + 1)).toLocaleDateString());
