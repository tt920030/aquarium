        ...
        <main>
            ...
            <div class="wrapper product_content">
                ...
                <div class="product_filter">
                    <div>
                        <ul>
                            <li class="filterByAll" @click="filterNumber= 1; resetToShow()"><h3>所有商品</h3></li>
                            <!-- <li class="filterByBest"><h3>熱門商品</h3></li> -->
                            <li class="filterByAnimal">
                                <h3 @click="toggleAnimal">依動物</h3>
                                <ul v-show="animalIsDroppedDown">
                                    <li @click="filterNumber = 2; resetToShow()"><h4>企鵝</h4></li>
                                    <li @click="filterNumber = 3; resetToShow()"><h4>海豚</h4></li>
                                    <li @click="filterNumber = 4; resetToShow()"><h4>魚類</h4></li>
                                    <li @click="filterNumber = 5; resetToShow()"><h4>水母</h4></li>
                                    <li @click="filterNumber = 6; resetToShow()"><h4>其他</h4></li>
                                </ul>
                            </li>
                            <li class="filterByType">
                                <h3 @click="toggleType">依種類</h3>
                                <ul v-show="typeIsDroppedDown">
                                    <li @click="filterNumber = 7; resetToShow()"><h4>玩偶</h4></li>
                                    <li @click="filterNumber = 8; resetToShow()"><h4>文具</h4></li>
                                    <li @click="filterNumber = 10; resetToShow()"><h4>食品</h4></li>
                                    <li @click="filterNumber = 9; resetToShow()"><h4>吊飾</h4></li>
                                    <li @click="filterNumber = 11; resetToShow()"><h4>其他</h4></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="wrapper page_list">
                <ul>
                    <Paginator :totalPage="totalPage" :filterNumber="filterNumber" :currentPage="currentPage" @currentPage="handleCurrentPage"></Paginator>
                </ul>
            </div>
        </main>        
    </div>
