            ...
            <div class="wrapper content">
                ...
                <div class="rightside">
                    ...
                    <div class="product_info">
                        ...
                        <h4 class="product_price" v-if="product">NTD ${{ product.PRICE }}</h4>
...
<script setup>
    ...
    import { ref, reactive, onBeforeMount, computed, onMounted, nextTick } from "vue";
    ...
    function addToCart(event){
        ...
        nextTick(() => {
            const data = {  "name": product.value.NAME , "price": product.value.PRICE, "amount": counter.value, "img":  'public/img/' + imgs[0]};
